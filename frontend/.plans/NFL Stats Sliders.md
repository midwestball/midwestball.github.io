...
**Zero mass = High** → still a reflected KDE (do not publish a 0-bin histogram). See frontend `docs/adr/2026-08-24-kde-only-league-shape.md`. **NGS / PFR missing** → gray, do not impute 0 (that would look like a real zero INT/drop).